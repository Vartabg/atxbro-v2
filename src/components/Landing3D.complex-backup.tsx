...
export default function Landing3D() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black">
      ...
      {/* App Interfaces */}
      <VetNavInterface visible={activeServiceId === "vetnav"} progress={activeServiceId === "vetnav" ? 1 : 0} />
      <TariffInterface visible={activeServiceId === "tariff-explorer"} progress={activeServiceId === "tariff-explorer" ? 1 : 0} />
      <PetRadarInterface visible={activeServiceId === "pet-radar"} progress={activeServiceId === "pet-radar" ? 1 : 0} />
      <JetsHomeInterface visible={activeServiceId === "fundraiser"} progress={activeServiceId === "fundraiser" ? 1 : 0} />
      )}
    </div>
  );
}
